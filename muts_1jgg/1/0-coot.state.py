...
set_graphics_window_size (489, 796)
...
handle_read_draw_molecule ("1jgg.pdb")
...
scale_zoom ( 1.00)
set_rotation_centre (23.79, 17.78, 40.11)
set_view_quaternion ( 0.0000,  0.0000,  0.0000,  1.0000)
